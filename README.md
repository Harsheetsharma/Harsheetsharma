...
- AI integration at system level (research interest)

I don’t just build CRUD apps — I focus on how systems behave under failure, load, and concurrency.

---
## Highlighted Projects

### OpsFlow
Workflow execution engine designed for distributed task processing.
...
### Paytm-Complete
Digital wallet simulation focusing on backend correctness and financial reliability patterns.
...
### Sentinel (WIP)
Security-oriented monitoring tool.
...
- Deeper distributed systems concepts
- OS internals
- Memory models & concurrency
- System design at scale
- AI model integration into backend tooling
